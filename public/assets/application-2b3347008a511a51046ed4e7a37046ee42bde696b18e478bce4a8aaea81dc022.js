...
window.analytics.load = function (apiKey) {
    ...
    script.async = true;
    script.src = ('https:' === document.location.protocol ? 'https://' : 'http://') + 'd2dq2ahtl5zl1z.cloudfront.net/analytics.js/v1/' + '7DFeP2D38qsmmlegdotnA62bJJiljXz1' + '/analytics.min.js';
...
window.analytics.load('7DFeP2D38qsmmlegdotnA62bJJiljXz1');
